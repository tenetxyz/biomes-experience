...
Your client's permissions button will need to specify the player actions that your smart contract will hook on to.
...
```typescript
//Example: Your smart contract hooks on to the MineSystem.
