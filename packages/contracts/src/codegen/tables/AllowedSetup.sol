...
library AllowedSetup {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "bazaar", name: "AllowedSetup", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746262617a6161720000000000000000416c6c6f776564536574757000000000);
