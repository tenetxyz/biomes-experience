...
library AllowedSetup {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "subpasschest", name: "AllowedSetup", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74627375627061737363686573740000416c6c6f776564536574757000000000);
