...
library AllowedSetup {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "grandexchange", name: "AllowedSetup", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626772616e6465786368616e676500416c6c6f776564536574757000000000);
