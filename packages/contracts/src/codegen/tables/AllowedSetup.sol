...
library AllowedSetup {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "wasdmember", name: "AllowedSetup", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462776173646d656d62657200000000416c6c6f776564536574757000000000);
