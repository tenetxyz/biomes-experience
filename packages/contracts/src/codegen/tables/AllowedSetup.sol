...
library AllowedSetup {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "settlersunion", name: "AllowedSetup", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462736574746c657273756e696f6e00416c6c6f776564536574757000000000);
   ...
   * @notice Get allowed.
   */
  function getAllowed(address player) internal view returns (bool allowed) {
   ...
   * @notice Get allowed.
   */
  function _getAllowed(address player) internal view returns (bool allowed) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   * @notice Get allowed.
   */
  function get(address player) internal view returns (bool allowed) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   * @notice Get allowed.
   */
  function _get(address player) internal view returns (bool allowed) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   * @notice Set allowed.
   */
  function setAllowed(address player, bool allowed) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   * @notice Set allowed.
   */
  function _setAllowed(address player, bool allowed) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   * @notice Set allowed.
   */
  function set(address player, bool allowed) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   * @notice Set allowed.
   */
  function _set(address player, bool allowed) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
