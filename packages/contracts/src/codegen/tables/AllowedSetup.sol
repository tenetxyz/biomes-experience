...
library AllowedSetup {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "sakuraenjoyer", name: "AllowedSetup", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746273616b757261656e6a6f79657200416c6c6f776564536574757000000000);
