...
library AllowedSetup {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ordendowntown", name: "AllowedSetup", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626f7264656e646f776e746f776e00416c6c6f776564536574757000000000);
