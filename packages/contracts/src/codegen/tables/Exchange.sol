...
library Exchange {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "grandexchange", name: "Exchange", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626772616e6465786368616e67650045786368616e67650000000000000000);
   ...
   * @notice Get rarity.
   */
  function getRarity(uint8 objectTypeId) internal view returns (uint256 rarity) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(objectTypeId));
   ...
   * @notice Get rarity.
   */
  function _getRarity(uint8 objectTypeId) internal view returns (uint256 rarity) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(objectTypeId));
   ...
   * @notice Set rarity.
   */
  function setRarity(uint8 objectTypeId, uint256 rarity) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(objectTypeId));
   ...
   * @notice Set rarity.
   */
  function _setRarity(uint8 objectTypeId, uint256 rarity) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(objectTypeId));
   ...
   */
  function set(uint8 objectTypeId, uint256 price, uint256 lastPurchaseTime, uint256 sold, uint256 rarity) internal {
    bytes memory _staticData = encodeStatic(price, lastPurchaseTime, sold, rarity);
   ...
   * @notice Set the full data using individual values.
   */
  function _set(uint8 objectTypeId, uint256 price, uint256 lastPurchaseTime, uint256 sold, uint256 rarity) internal {
    bytes memory _staticData = encodeStatic(price, lastPurchaseTime, sold, rarity);
  ...
  function set(uint8 objectTypeId, ExchangeData memory _table) internal {
    bytes memory _staticData = encodeStatic(_table.price, _table.lastPurchaseTime, _table.sold, _table.rarity);
  ...
  function decodeStatic(
    bytes memory _blob
  ) internal pure returns (uint256 price, uint256 lastPurchaseTime, uint256 sold, uint256 rarity) {
    ...
    rarity = (uint256(Bytes.getBytes32(_blob, 96)));
  }
  ...
  function decode(
    ...
    (_table.price, _table.lastPurchaseTime, _table.sold, _table.rarity) = decodeStatic(_staticData);
  }
  ...
  function encodeStatic(
    ...
    return abi.encodePacked(price, lastPurchaseTime, sold, rarity);
  }
