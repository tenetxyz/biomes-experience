...
library Metadata {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "sellchest", name: "Metadata", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746273656c6c636865737400000000004d657461646174610000000000000000);
