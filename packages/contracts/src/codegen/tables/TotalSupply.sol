...
library TotalSupply {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "stablechest", name: "TotalSupply", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462737461626c656368657374000000546f74616c537570706c790000000000);
