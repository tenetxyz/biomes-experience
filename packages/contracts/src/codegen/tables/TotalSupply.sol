...
library TotalSupply {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "dynamicchest", name: "TotalSupply", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746264796e616d696363686573740000546f74616c537570706c790000000000);
   ...
   * @notice Get supply.
   */
  function getSupply(uint8 objectTypeId) internal view returns (uint256 supply) {
   ...
   * @notice Get supply.
   */
  function _getSupply(uint8 objectTypeId) internal view returns (uint256 supply) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(objectTypeId));
   ...
   * @notice Get supply.
   */
  function get(uint8 objectTypeId) internal view returns (uint256 supply) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(objectTypeId));
   ...
   * @notice Get supply.
   */
  function _get(uint8 objectTypeId) internal view returns (uint256 supply) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(objectTypeId));
   ...
   * @notice Set supply.
   */
  function setSupply(uint8 objectTypeId, uint256 supply) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(objectTypeId));
   ...
   * @notice Set supply.
   */
  function _setSupply(uint8 objectTypeId, uint256 supply) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(objectTypeId));
   ...
   * @notice Set supply.
   */
  function set(uint8 objectTypeId, uint256 supply) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(objectTypeId));
   ...
   * @notice Set supply.
   */
  function _set(uint8 objectTypeId, uint256 supply) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(objectTypeId));
