...
library ShopMetadata {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ordendowntown", name: "ShopMetadata", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626f7264656e646f776e746f776e0053686f704d6574616461746100000000);
