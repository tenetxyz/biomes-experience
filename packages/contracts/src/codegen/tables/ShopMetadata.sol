...
library ShopMetadata {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "subpasschest", name: "ShopMetadata", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462737562706173736368657374000053686f704d6574616461746100000000);
