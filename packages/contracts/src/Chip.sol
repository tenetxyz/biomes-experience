  ...
  function initChip() internal {
    setChipMetadata(
      ChipMetadataData({
        ...
        name: "Buy & Sell Blocks",
        description: "Send payment to players for placing blocks in your chest, let players take blocks from your chest by sending you a payment. A 1% fee is applied to all transactions."
      })
    );
  }
