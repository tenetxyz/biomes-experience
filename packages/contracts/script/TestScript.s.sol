...
bytes14 constant BANK_TOKEN_NAMESPACE = "TDC";
...
contract TestScript is Script {
  function run(address worldAddress) external {
    ...
    IERC20Mintable bankToken = registerERC20(
      ...
      MUDERC20MetadataData({ decimals: 18, name: "The Dirt Coin", symbol: "TDC" })
    );
    ...
    IExperienceWorld(worldAddress).experience__setMUDTokenMetadata(
      ...
      ERC20MetadataData({
        ...
        symbol: "TDC",
        name: "The Dirt Coin",
        description: "The Dirt Coin is a token that is used to purchase essential tools for cheap in their shops.",
    ...
    Metadata.setPaymentToken(bankTokenAddress);
