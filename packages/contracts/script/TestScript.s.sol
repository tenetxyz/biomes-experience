...
import { ChipObjectID } from "@biomesaw/world/src/ObjectTypeIds.sol";

import { ShopNFT } from "../src/codegen/tables/ShopNFT.sol";
import { NFTMetadata } from "../src/codegen/tables/NFTMetadata.sol";
import { OwnedNFTs } from "../src/codegen/tables/OwnedNFTs.sol";

import { encodeAddressExchangeResourceId } from "@biomesaw/experience/src/utils/ExchangeUtils.sol";
...
contract TestScript is Script {
  function run(address worldAddress) external {
    ...
    console.logBytes32(encodeAddressExchangeResourceId(shopNFTAddress));
    ...
    NFTMetadata.set(shopNFTAddress, 0xE0ae70caBb529336e25FA7a1f036b77ad0089d2a, ChipObjectID, 1, 0);
    OwnedNFTs.push(0xE0ae70caBb529336e25FA7a1f036b77ad0089d2a, shopNFTAddress);
