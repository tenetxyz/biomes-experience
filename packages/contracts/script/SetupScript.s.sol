...
contract SetupScript is Script {
  function run(address worldAddress) external {
    ...
    bytes32 chestEntityId = 0x00000000000000000000000000000000000000000000000000000000001006b3;
    uint8 buyObjectTypeId = SakuraLogObjectID;
    uint256 buyPrice = 1e18;
    uint256 buyAmount = 99 * 12;
    address paymentToken = 0x4ec4101A17d26657e678A8BC0Bb1a485069d759E;
    chipAddress.call(
