...
contract SetupScript is Script {
  function run(address worldAddress) external {
    ...
    bytes32 chestEntityId = 0x00000000000000000000000000000000000000000000000000000000000883d6;
    uint8 buyObjectTypeId = SakuraLogObjectID;
    uint256 buyPrice = 1e18;
    uint256 buyAmount = 99 * 12;
    address paymentToken = 0xcc0d2185945Df9770288cf1B1A0b53559c017D40;
    chipAddress.call(
